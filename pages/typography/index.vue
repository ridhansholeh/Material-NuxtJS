<template>
	<div class="content__inner">
		...
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">Body Copy</h4>
		...
		<div class="card">
			<div class="card-body">
				...
				<h6 class="card-subtitle">All HTML headings, <code>&#x3C;h1&#x3E;</code> through <code>&#x3C;h6&#x3E;</code>, are available.</h6>
		...
		<div class="card">
			<div class="card-body">
				...
				<h6 class="card-subtitle">Traditional heading elements are designed to work best in the meat of your page content. When you need a heading to stand out, consider using a <b>display heading</b> - a larger, slightly more opinionated heading style.</h6>
		...
		<div class="card">
			<div class="card-body">
				...
				<h6 class="card-subtitle">Make a paragraph stand out by adding <code>.lead</code>.</h6>
		...
		<div class="card">
			<div class="card-body">
				<h4 class="card-title">Text utilities</h4>
				<h6 class="card-subtitle">Change text alignment, transform, style, weight, and color with Bootstrap's text utilities.</h6>

				<div class="card-body__title">Text alignment</div>
				...
				<hr>
				<br>
				<div class="card-body__title">Text wrapping and overflow</div>
				<p>Prevent text from wrapping with a <code>.text-nowrap</code> class.</p>
				<br>
				<div class="text-nowrap" style="width: 8rem;">
					This text should overflow the parent despite the width.
				</div>
				...
				<hr>
				<br>
				<div class="card-body__title">Text transform</div>
				...
				<hr>
				<br>
				<div class="card-body__title">Font weight and italics</div>
		...
		<div class="card">
			<div class="card-body">
				...
				<h6 class="card-subtitle">Stylized implementation of HTML’s <code>&#x3C;abbr&#x3E;</code> element for abbreviations and acronyms to show the expanded version on hover. Abbreviations have a default underline from Normalize.css and gain a help cursor to provide additional context on hover and to users of assistive technologies.</h6>
		...
		<div class="card">
			<div class="card-body">
				...
				<h6 class="card-subtitle">For quoting blocks of content from another source within your document. Wrap <code>&#x3C;blockquote class=&#x22;blockquote&#x22;&#x3E;</code> around any HTML as the quote.</h6>
				...
				<hr>
				<br>
				<div class="card-body__title">Naming a source</div>
				...
				<hr>
				<br>
				<div class="card-body__title">Alignment</div>
		...
		<div class="card">
			<div class="card-body">
				...
				<h6 class="card-subtitle">All lists <code>&#x2014;&#x3C;ul&#x3E;</code>, <code>&#x3C;ol&#x3E;</code>, and <code>&#x3C;dl&#x3E;&#x2014;</code> have their margin-top removed and a <code>margin-bottom: 1rem</code>. Nested lists have no margin-bottom.</h6>
				<div class="card-body__title">Custom styled</div>
				...
				<hr>
				<br>
				<div class="card-body__title">Unstyled</div>
				...
				<hr>
				<br>
				<div class="card-body__title">Inline</div>
		...
		<div class="card">
			<div class="card-body">
				...
				<h6 class="card-subtitle">Align terms and descriptions horizontally by using our grid system’s predefined classes (or semantic mixins). For longer terms, you can optionally add a <code>.text-truncate</code> class to truncate the text with an ellipsis.</h6>
				<dl class="row">
